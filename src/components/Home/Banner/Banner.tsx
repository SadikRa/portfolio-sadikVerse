...
//   return (
//     <div className="relative flex flex-col md:flex-row items-center justify-between min-h-[90vh] px-4 sm:px-6 lg:px-8 bg-background text-foreground">
//       <motion.div
...
//       >
//         <img
//           src="https://i.ibb.co.com/chBVQ2wQ/profile.jpg"
//           alt="Profile Picture"
//           width={300}
//           height={300}
  ...
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-between min-h-[90vh] px-4 sm:px-6 lg:px-8 bg-background text-foreground">
      ...
      >
        ...
        <a href="https://drive.google.com/file/d/1rdVEQ8hhTBO-ilutDYLVDMLknMFHVdSn/view?usp=sharing">
          <Button className="mt-6 px-6 py-5 text-lg font-semibold bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg transition-transform transform hover:scale-105">
            Download Resume
          </Button>
        </a>
      </motion.div>
      ...
      <motion.div
        ...
        animate={{ scale: 1, opacity: 1 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className="w-[300px] h-[300px] mt-10 md:mt-0"
      >
        <Canvas>
